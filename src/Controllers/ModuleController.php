...
class ModuleController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $modules = Module::all();
        return redirect()->route(config('Crm.adminRoute') . '.modules.index', ['modules' => $modules]);
    }
    ...
    public function save_role_module_permissions(Request $request, $id)
    {
        ...
        return redirect(config('Crm.adminRoute') . '/modules/' . $id . "#access");
    }
    ...
    /**
     * Get Array of all Module Files generated by Crm
     *
     * @param Request $request
     * @param $module_id Module ID
     * @return \Illuminate\Http\JsonResponse
